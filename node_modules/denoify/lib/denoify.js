...
async function denoify(params) {
    ...
    const denoifyParamsFromPackageJson = (_b = packageJsonParsed["denoify"]) !== null && _b !== void 0 ? _b : {};
    {
        ...
        if ((includes !== undefined &&
            !includes.every(pathOrObj => typeof pathOrObj === "string" ||
    ...
    generateModFile({
        ...
        denoDistPath,
        srcDirPath,
        "explicitlyProvidedIndexFilePath": (_c = params.indexFilePath) !== null && _c !== void 0 ? _c : denoifyParamsFromPackageJson.index
    });
    {
        const includes = ((_d = denoifyParamsFromPackageJson.includes) !== null && _d !== void 0 ? _d : ["README.md", "LICENSE"]).map(pathOrObj => typeof pathOrObj === "string"
